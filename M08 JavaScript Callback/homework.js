...
function mayuscula(nombre) {
   ...
   /*var conMay = nombre.split('');

   conMay[0] = conMay[0].toUpperCase();
...
function filter(arrayOfStrings) {
  ...
  /* for (i=0; i<arrayOfStrings.length; i++){
   ...
   nuevoArray = arrayOfStrings.filter((elem)=>{//Metodo "filter"
      return elem[0] === "a";
   });

  /* arrayOfStrings.map((elem)=>{
      if (elem[0]=== "a" || elem[0]==="A"){
         return nuevoArray.push(elem);
      }
    });*/
